...
2026-09-20 layout update: the default Trading desk now follows the local preview: restrained dark theme, top navigation, compact Intraday and Swing cards, no stacked secondary expanders. Watchlist retains intraday observations and swing ranking; News retains both reviewers; History remains unchanged. Research and rising-trend tools are in Reports, buying checks in Past results, and bid/offer tools in Stock detail. Only real qualifying stocks appear; closed-market captures are not current opportunities.
